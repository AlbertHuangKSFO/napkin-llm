...
**EP320 卡数怎么算齐(推导)**。DeepSeek-V3 只有 **256 个路由专家**,decode 却用 **320 卡**——多出的 64 卡不是凭空冒出的。拆账:256 路由专家按「每卡 1 个」恰好占 **256 卡**;再为热门专家做冗余复制 + 安放共享专家,额外 **64 卡**;$256+64=\mathbf{320}$,即 EP320。所以「每卡 1 专家」只对那 256 张**路由卡**成立,另 64 张是冗余/共享卡。这也解释了为何不是整 256 或整 512:320 = 路由专家数 + EPLB 给热点留的冗余余量,余量大小由线上负载统计定(见 [[061 专家并行 EP：大规模 MoE 服务|EP]] 的 shared/冗余专家放置)。
